...
forceSlider = Slider(forceSlider, 'force', 0, 1_000_000, valinit=force, valstep=1000)

recalculateStress(numberOfNodes, force, thickness, xRange, xRange,ax,cax, fig, ax1)
